...
대부분 위 루트를 타고 오셨을 것이다.
<blockquote> ✅ 깃허브 블로그를 처음 생성하시는 거라면 <a href="https://github.com/mmistakes/minimal-mistakes">minimal-mistakes</a> 테마로 시작하시길 추천</blockquote>
...
심플하게 [Trophy](http://jekyllthemes.org/themes/trophy/) 테마를 사용하고 있었다.   
<br/>
로컬 환경에서 실행 했을 땐 아무 문제없이 작동했는데,   
레포에 푸쉬해서 github page로 [호스팅](https://ko.dict.naver.com/#/entry/koko/2a065eadc14840dfbd62fb729234e4b5) 할 때는   
카테고리 페이지만 <u>404 에러</u>가 뜨는 것이었다.   
<br/>
테마를 만든 분의 깃허브를 들어가 [이슈](https://github.com/thomasvaeth/trophy-jekyll/issues/49)를 보니 나와 같은 현상을 겪는 분들이 계셨고,   
...
<br/>
그 외 처음에 골랐던 [Plain-Webcomic](https://peahatlanding.github.io/Plain-Webcomic/docs/index.html) 테마도 사용해보려 했으나,   
...
- [1-1. 레포 생성부터 index.html 로 초기 설정](https://supermemi.tistory.com/entry/%EB%82%98%EB%A7%8C%EC%9D%98-%EB%B8%94%EB%A1%9C%EA%B7%B8-%EB%A7%8C%EB%93%A4%EA%B8%B0-Git-hub-blog-GitHubio)
- [1-2. 전체적인 초기 셋팅1 SW delveloper님 블로그 (리눅스 환경)](https://devinlife.com/howto/)
- [1-3. 전체적인 초기 셋팅2 DangHyeona님 블로그 (윈도우 환경)](https://eona1301.github.io/a_to_z/GithubBlog/)
- [1-4. 초기 셋팅 후 minimal-mistakes 테마로 시작 하실거라면 식빵맘님 블로그](https://ansohxxn.github.io/)
- [1-5. 쉬운 설명으로 풀어 설명해주시는 bomyuniverse님 벨로그](https://velog.io/@bomyuniverse/createAGitHubBlog1)

## 2. 그럼에도 다른 테마를 하고 싶으시다면
- [2-1. jekyllthemes 1](http://jekyllthemes.org/)
- [2-2. jekyllthemes 2](https://jekyllthemes.dev/)
- [2-3. jekyllthemes 3](https://jekyllthemes.io/free)
<hr/>

## [3. 깃허브 가입하기 클릭]({{site.url}}/git%20&%20github/깃허브가입/)