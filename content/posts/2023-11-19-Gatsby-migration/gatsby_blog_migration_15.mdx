---
title: 15. Netlify로 배포하기 | 깃허브 블로그 Gatsby 'minimal-blog' 테마로 마이그레이션 하기
date: 2023-11-15
slug: '/gatsby-blog-migration-15'
tags:
 - Github Blog
---
...
2. 가입하면서 자연스럽게 절차가 첫 프로젝트를 배포하라는 가이드가 이어집니다.
...
▶️ [[다음 포스트] 16. Google, 네이버 웹 마스터, Bing 웹 마스터, Daum 검색 등록하기](/gatsby-blog-migration-16)
